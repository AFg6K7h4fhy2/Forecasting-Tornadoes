...
Uses linear regression to predict the number of tornadoes in future years.
"""
...
def main():
    ...
    print(
        f"Assuming a linear change over year, we predict {mean_number_of_tornadoes_target_year:.1f} tornadoes in the month of April"
    )
